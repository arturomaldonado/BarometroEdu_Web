...
Otro programa de software libre es [RStudio](https://posit.co), que es una interface gráfica IDE para R. En estos enlaces se pueden descargar estos programas. Primero descargue R y luego RStudio. Ambos tiene versiones para Windows, IOS o Linux.
...
En esta ventana se puede escoger un nuevo directorio o uno ya existente. También hay una opción de control de versiones, que se puede asociar a un repositorio de GitHub.
